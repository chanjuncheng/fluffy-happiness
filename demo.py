...
# calculate prob of input image/frame
# crop roi for sample_num(10) times and concatenate rois
...
def run(input_dir):
    ...
    for f_name in f_list:
        # Parse video
        f_path = os.path.join(input_dir, f_name)    # concatenate path components (e.g /Desktop/image.jpg)
        ...
        if suffix.lower() in ['jpg', 'png', 'jpeg', 'bmp', 'tif', 'nef', 'raf']:
            ...
            # get prob of each img/frame in the video
