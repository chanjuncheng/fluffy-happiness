...
def im_test(im):
    ...
    if len(face_info) == 0:
        ...
        for trans_matrix, point in face_info:
            ...
            roi, _ = lib.cut_head([im], point)   # roi = cropped im; _ = location of coordinates
            # print(roi)
            #print(roi[0].shape)
            #print(point)

            aligned_im, aligned_lm = lib.get_aligned_face_and_landmarks(im, face_info, 256, (0,0) )
            ...
            #d = lib.get_face_loc(roi[0], front_face_detector, scale=0)
